 ...
 */
export type AnyBundleConfig<TItem extends Record<string, unknown>> = CreateBundleConfig<TItem> | SimpleBundleConfig<TItem>;
/**
 ...
 * @internal
 */
export type RangeColumnsJSON = Record<string, {
    encoding: 'b64f64';
    data: string;
}>;
/**
